...
test.describe("Menu Component", () => {
  test("With hamburger closed snapshot", async ({ page }) => {
    await page.goto("/iframe.html?id=components-menu--with-hamburger&viewMode=story");
  ...
  test("Left aligned snapshot", async ({ page }) => {
    await page.goto("/iframe.html?id=components-menu--left-aligned&viewMode=story");
    await page.waitForLoadState("networkidle");
