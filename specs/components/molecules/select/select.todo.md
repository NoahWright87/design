...
## Sooner
- [x] Open/close animation: Add an animated open state — unroll, slide, or fade. Default should be slightly whimsical but professional.
...
- [x] Scrollable dropdown: Cap the dropdown list height when there are many options. Add a `maxVisibleItems` prop (e.g. default 8) to control the scroll cutoff.
