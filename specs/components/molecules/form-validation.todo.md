...
## Sooner
- [ ] Error display without layout shift: Error messages currently push surrounding content out of place when they appear. Decide on and implement one of these approaches consistently across all form components:
